...
urlpatterns = [
    ...
    path("user/<int:pk>/", UserManageView.as_view(), name="update-user"),
    path("user/<int:pk>/", UserManageView.as_view(), name="delete-user"),
    path('users/', UserListView.as_view(), name='user-list'),
    path('user/<int:pk>/', UserManageView.as_view, name='user-detail'),
]
